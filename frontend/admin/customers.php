            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    <thead class="bg-gray-50">
                        <tr>
                            <th class="text-left py-4 px-6 font-semibold text-gray-700">Reklama nomi</th>
        ...
        <form id="customerForm" class="p-6 space-y-4">
            ...
            <div>
                ...
                <input 
                    ...
                    required
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    placeholder="Masalan: Kosonsoyliklar, iPost pochta"
                >
                <p class="text-xs text-gray-500 mt-1">Bu sizning asosiy reklama nomingiz</p>
            </div>
            ...
            <div>
                ...
                <input 
                    ...
                    name="contact_person"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    placeholder="Masalan: Oqilxon Tillaxonov"
                >
                <p class="text-xs text-gray-500 mt-1">Aloqa uchun shaxs ismi</p>
            </div>
        ...
        <tr class="border-b hover:bg-gray-50 transition">
            <td class="py-4 px-6">
                <div class="flex items-center space-x-3">
                    <div class="w-12 h-12 bg-gradient-to-r from-blue-400 to-purple-500 rounded-full flex items-center justify-center text-white font-bold text-lg">
                        ${customer.ad_name.substring(0, 2).toUpperCase()}
                    </div>
                    <div>
                        <p class="font-semibold text-blue-600">${customer.ad_name}</p>
            ...
            <td class="py-4 px-6">
                <div class="flex items-center justify-end space-x-2">
                    ...
                    <button onclick="deleteCustomer(${customer.id}, '${customer.ad_name}')" class="text-red-600 hover:text-red-700 p-2" title="O'chirish">
...
async function editCustomer(id) {
    try {
        ...
        if (result.success) {
            ...
            document.getElementById('adName').value = customer.ad_name;
